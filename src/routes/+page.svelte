...
<NavBar />
  <section id="home" class="flex flex-col  justify-end items-end  md:flex-row md:h-screen md:items-center md:justify-between py-10 px-16 rounded-b-3xl" on:mousemove={handleMouseEvent} >
    
    <div class="flex justify-center  lg:w-[600px] w-full lg:h-[600px] h-96 bg-ed-200 z-20">
      ...
      <Threlte.Canvas shadows>
        ...
        <!-- ... -->
        <Extra.GLTF url="../assets/my-avatar.glb" position={{x: 0, y:-0.75, z: 0}} castShadow />
        <Threlte.Mesh
        position={{ y : -0.75}}
...
<style>
  ...
  .bg-gradient {
    background: radial-gradient(at var(--bg-size),deepskyblue,darkviolet,blue);
